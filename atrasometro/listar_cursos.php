...
?>
    ...
    <div class="container" style="margin-top: 40px">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <?php 
                            if(($nivel == 1)||($nivel == 2)){
                            ?>
                            <a href="editar_curso.php?id=<?php echo $id_curso ?>" role="button"
                                class="btn btn-dark btn-sm"><i class="far fa-edit"></i>&nbsp; Editar</a>
                            <?php } ?>
                            <?php 
                            if(($nivel == 1)){
                            ?>
                            <a href="deletar_curso.php?id=<?php echo $id_curso ?>" role="button"
        ...
        <div style="text-align: right; margin-top:20px;">
            <a href="adicionar_curso.php" role="button" class="btn btn-success btn-sm">Cadastrar curso</a>
