...
<body>
    ...
    <div class="container" style="margin-top: 40px" id="container">
        ...
        <form action="_atualizar_turma.php" method="post" style="margin-top: 20px">
            <?php 
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="id" value="<?php echo $id_turma?>" style="display:none;">
            </div>
